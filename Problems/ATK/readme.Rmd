...
1. Melakukan transformasi kepada data yang memiliki _range_ yang sangat lebar. Transformasi yang bisa dilakukan antara lain:
    1. _Scaling_ dengan formula berikut: $\hat{X} = \frac{X-\bar{X}}{X_{max}-X_{min}}$.
    1. _Standardization_ dengan formula berikut: $\hat{X} = \frac{X-\bar{X}}{\sigma_X}$.
    1. Fungsi logaritmik dengan formula berikut: $\hat{X} = \log{X}$.
    1. Fungsi transformasi _Tukey_ lainnya.
