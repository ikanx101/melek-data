...
Dari grafik di atas, kita melihat _range_ harga yang cukup jauh di beberapa jenis satuan. Oleh karena itu, kami melakukan transformasi logaritmik agar _range_-nya menjadi lebih _comparable_.
...
1. Melakukan analisa deskriptif.
    ...
    - Melihat _time range_ yang dijadikan basis strategi _inbound-outbound_ ATK.
1. Melakukan _clustering_ untuk mengelompokkan ATK sesuai dengan kesamaan karakteristiknya.
    - Apakah bisa dibuat strategi berdasarkan kelompok ATK yang dibuat?
    - Apakah ada perhitungan _safety stock_ yang spesifik di setiap _cluster_ tersebut?
